# xapiweb — X Web API Python Library 🐦 (v1.5.1)
...
| Version | Added |
|---|---|
| **v1.5.1** | 🔔 **Notifications list** (`notifications.list()` All/Verified/Mentions + `extract_notifications()` parser + paging, user-captured qid, live proven) |
...
```bash
unzip xapiweb-v1.5.1.zip && cd xapiweb-v1.5.1
